    ...
    <div>
      ...
      <div className="flex gap-8 max-w-7xl mx-auto px-4 py-8">
        ...
        {!editing && toc.length > 0 && (
          <aside className="hidden lg:block w-56 shrink-0">{tocNav}</aside>
        )}
                ...
                <div className="flex items-center gap-4 mt-1">
                  ...
                  {draft.titleImageUrl && (
                    <Button
                      ...
                      variant="ghost"
                      onClick={() =>
                        setDraft((d) => ({ ...d, titleImageUrl: null }))
                      }
                    >
                      Remove
                    </Button>
                    ...
                    <input
                      ...
                      onChange={async (e) => {
                        ...
                        try {
                          ...
                          if (textarea) {
                            const start =
                              textarea.selectionStart ?? draft.content.length;
              ...
              {data.content ? (
                ...
                isAdmin && (
                  <p className="text-gray-400 italic">
                    No content yet. Click &ldquo;Edit page&rdquo; to add
                    content.
                  </p>
                )
              )}
