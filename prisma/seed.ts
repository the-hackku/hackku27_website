...
async function main() {
  ...
  const rooms = await Promise.all([
    prisma.themedRoom.create({
      data: { name: "Dungeon Hall", location: "Engineering Hall Room 1450" },
    }),
    prisma.themedRoom.create({
      data: { name: "Dragon Den", location: "Learned Hall Room 212" },
    }),
    prisma.themedRoom.create({
      data: { name: "Fairy Forest", location: "Eaton Hall Room 2001B" },
    }),
    prisma.themedRoom.create({
      data: { name: "Shadow Spire", location: "Nichols Hall Room 246" },
    }),
    prisma.themedRoom.create({
      data: { name: "Arcane Library", location: "Watson Library Room 320" },
    }),
  ]);
  ...
  for (let i = 0; i < 7; i++) {
    userDefs.push({
      role: "VOLUNTEER",
      email: `volunteer${i + 1}@hackku.test`,
  ...
  console.log(
    `Created ${created} users with ParticipantInfo (3 admin, 7 volunteer, 20 hacker)`,
  );
  ...
  const events = await Promise.all([
    ...
    prisma.event.create({
      data: {
        ...
        description: "Pick up your badge, swag bag, and get settled in.",
        eventType: "REQUIRED",
      },
    }),
    prisma.event.create({
      data: {
        ...
        startDate: dt(0, 19),
        endDate: dt(0, 20),
        location: "Eaton Hall Auditorium",
        description:
          "Welcome to HackKU 2026! Hear from organizers and sponsors.",
        eventType: "REQUIRED",
      },
    }),
    prisma.event.create({
      data: {
        ...
        description: "Submissions open — start building!",
        eventType: "REQUIRED",
      },
    }),
    prisma.event.create({
      data: {
        name: "Dinner",
        startDate: dt(0, 20, 30),
        endDate: dt(0, 21, 30),
        location: "Engineering Hall Lobby",
        description: "Fuel up for the first night of hacking.",
        eventType: "FOOD",
      },
    }),
    ...
    prisma.event.create({
      data: {
        ...
        endDate: dt(1, 1),
        location: "Engineering Hall Lobby",
        description: "Late-night snacks to keep you going.",
        eventType: "FOOD",
      },
    }),
    ...
    prisma.event.create({
      data: {
        name: "Sponsor Tech Talk",
        startDate: dt(1, 11, 30),
        endDate: dt(1, 12, 30),
        location: "Eaton Hall Room 2001B",
        description: "Learn about cutting-edge tech from our sponsors.",
        eventType: "SPONSOR",
      },
    }),
    prisma.event.create({
    ...
    prisma.event.create({
      data: {
        name: "Cup Stacking Tournament",
        startDate: dt(1, 15, 30),
        endDate: dt(1, 16, 30),
        location: "Engineering Hall Atrium",
        description:
          "Take a break and compete in the legendary cup stacking contest.",
    ...
    prisma.event.create({
      data: {
        ...
        endDate: dt(1, 18),
        location: "Engineering Hall Lobby",
        description: "Evening dinner — keep the energy up!",
        eventType: "FOOD",
      },
    }),
    ...
    prisma.event.create({
      data: {
        ...
        endDate: dt(2, 0, 30),
        location: "Engineering Hall Lobby",
        description: "Second night snacks.",
        eventType: "FOOD",
      },
    }),
    ...
    prisma.event.create({
      data: {
        ...
        endDate: dt(2, 9),
        location: "Engineering Hall Lobby",
        description: "Final morning breakfast before submissions close.",
        eventType: "FOOD",
      },
    }),
    prisma.event.create({
    ...
    prisma.event.create({
      data: {
        ...
        endDate: dt(2, 13),
        location: "Engineering Hall Atrium",
        description: "Demo your project to judges and other hackers.",
        eventType: "REQUIRED",
      },
    }),
    prisma.event.create({
      data: {
        ...
        startDate: dt(2, 13, 30),
        endDate: dt(2, 15),
        location: "Eaton Hall Auditorium",
        description: "Awards, prizes, and farewell.",
        eventType: "REQUIRED",
      },
    }),
  ]);
