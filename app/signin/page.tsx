          ...
          {emailSent ? (
            <>
              <p className="text-center text-gray-600 text-sm sm:text-base">
                We have sent a one-time code to <strong>{emailWatch}</strong>.
              </p>
              <p className="text-center text-gray-600 mt-2 text-sm sm:text-base">
                Please check your inbox and use the code to sign in.
              </p>
              <p className="text-center text-gray-600 mt-2 text-sm sm:text-base p-2 bg-indigo-50 rounded">
                ...
                <b>sign in with an OAuth provider below instead</b>. If you're
                new, signing up means you agree to our{" "}
                <Link
